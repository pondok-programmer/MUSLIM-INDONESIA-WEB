      ...
      <main className='flex h-full w-full flex-col items-center [&_input]:placeholder:text-white sm:gap-4 lg:flex-row lg:gap-0'>
        ...
        <section className='w-[80%] sm:w-[70%] lg:w-[50%] lg:p-14 lg:h-full flex items-center justify-center lg:flex-col lg:gap-3'>
          <div className='lg:border-white lg:border lg:h-[85%] lg:w-[54vh] lg:flex lg:flex-col lg:rounded-md w-full'>
            ...
            <form className='flex flex-col gap-8 p-3 sm:gap-14 lg:py-7 lg:gap-10 lg:flex-1 lg:px-12'>
              <div className='flex flex-col gap-12 sm:gap-9'>
                <InputCustom type='email' placeholder={'Email'} className={'sm:text-[24px] focus:ring-0 text-[2.3vh] border-none outline-none w-full sm:w-[90%] pb-2 px-3 pt-2 '} classNameDiv={'border-b-[1.7px] pt-3 border-[#fff]'} icon={<CiMail className='text-2xl sm:text-[27px] p-0 m-0 text-white'/>}/>
                <InputCustom type='password' placeholder={'Kata Sandi'} className={'sm:text-[24px] text-[2.3vh] focus:ring-0 border-none outline-none w-full sm:w-[90%] pb-2 px-3 pt-2'} classNameDiv={'border-b-[1.7px] pt-3 border-[#fff]'} icon={<CiLock className='text-2xl sm:text-[27px] text-white'/>}/>
              </div>
              <div className='w-full flex flex-col items-center gap-1 lg:gap-0 [&_button]:rounded-3xl [&_button]:w-[60%]'>
                  <Link to="/home" className={"h-full w-full flex justify-center items-center"}>
                    <ButtonCustom value={'Login'} className={' bg-gradient-to-br from-lime-400 to-lime-700 rounded-3xl text-[14px] text-white font-[700] py-4 sm:text-[16px] '}/>
                  </Link>
