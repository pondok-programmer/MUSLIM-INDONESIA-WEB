          ...
          <div className={`lg:border-white lg:border-2 w-[76%] sm:w-[75%] backdrop-blur-[2px] lg:border-opacity-75 lg:!min-h-[85%] lg:w-[54vh] lg:rounded-md flex flex-col`} style={{minHeight:`${maxH*(0.6)}px`}}>
            ...
            <form onSubmit={(e)=>{handleRegister(e)}} className='flex flex-col justify-between gap-8 sm:gap-0 sm:flex-[0.4] lg:gap-0 lg:flex-1 lg:text-[14px] lg:px-10 ' autoComplete={toString("on")}>
              ...
              <div className='w-full relative flex flex-col items-center gap-0.5 sm:gap-0.5 lg:gap-0 [&_button]:rounded-3xl max-lg:py-[2%] lg:h-[25%]'>
                ...
                <button type="submit" className='w-[100%] sm:w-[50%] sm:py-[3%] colorful-button max-md:!rounded-xl rounded-3xl text-[14px] lg:text-[15px] text-white font-[700] py-[4%] flex items-center justify-center sm:text-[16px] cursor-pointer min-h-[35px] min-w-[115px]' autoComplete='on'>
